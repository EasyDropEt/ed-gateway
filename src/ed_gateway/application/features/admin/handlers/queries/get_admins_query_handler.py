...
class GetAdminsQueryHandler(RequestHandler):
    def __init__(self, api: ABCApi):
        ...
        self._error_message = "Failed to fetch admins."

    async def handle(self, request: GetAdminsQuery) -> BaseResponse[list[AdminDto]]:
        LOG.info("Calling core get_admins API")
        response = await self._api.core_api.get_admins()
        ...
        return BaseResponse[list[AdminDto]].success(
